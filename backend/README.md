...
## Project Structure
    ...
    ├── testapiautosetting_125127  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125127`
...
2. Clone this repo and `cd testapiautosetting_125127`
